...
export default function Footer() {
  ...
  const address = settings?.dealerAddress || 'Jl. Otto Iskandardinata No.314, Subang, Jawa Barat 41211';
  const operationalHours = settings?.operationalHours || 'Senin - Sabtu: 08:30 - 16:00';
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-3">
                ...
                <a href={`tel:${phone}`} className="hover:text-gray-300 transition-colors">
                  {phone}
                </a>
              </div>
              <div className="flex items-start space-x-3">
                <Mail size={18} className="mt-0.5 shrink-0 text-[#C90010]" />
                <a href={`mailto:${email}`} className="hover:text-gray-300 transition-colors break-all">
                  {email}
                </a>
              </div>
              <div className="flex items-start space-x-3">
              ...
              <div className="flex items-start space-x-3">
                <Clock size={18} className="mt-0.5 shrink-0 text-[#C90010]" />
